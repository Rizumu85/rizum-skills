...
**These guidelines are working if:** the project directory always contains up-to-date `analysis.md`, `design.md`, and `plan.md` files; context is easily transferable between agents; execution perfectly matches the checked-off steps; full testing is safely delegated to the user; documentation shifts dynamically with implementation changes; and chat change summaries are consistently delivered in Chinese.
